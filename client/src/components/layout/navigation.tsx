...
export default function Navigation() {
  ...
  const showCommunity = ["tenant", "hostel_admin", "hostel_team"].includes(user.role);
  const isCafeManager = user.role === "cafe_manager";
  const isAdminUser = user.role === "hostel_admin" || user.role === "hostel_team";
  ...
  const navigation = [
    ...
    ...(showRooms ? [{ name: "Common Rooms", href: "/rooms", current: location === "/rooms" }] : []),
